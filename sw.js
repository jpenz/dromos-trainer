const CACHE = "dromos-trainer-v59";
const APP_SHELL = [
  "./", "./index.html", "./manifest.webmanifest", "./css/styles.css?v=59", "./css/fonts.css?v=14",
  ...
  "./js/triads.js?v=17", "./js/fretboard.js?v=52", "./js/guitar-voicings.js?v=14", "./js/audio.js?v=38", "./js/page-guides.js?v=59", "./js/app.js?v=59",
