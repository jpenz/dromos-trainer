const CACHE = "dromos-trainer-v32";
const APP_SHELL = [
  "./", "./index.html", "./manifest.webmanifest", "./css/styles.css?v=32", "./css/fonts.css?v=14",
  ...
  "./js/triads.js?v=17", "./js/fretboard.js?v=31", "./js/guitar-voicings.js?v=14", "./js/audio.js?v=31", "./js/page-guides.js?v=31", "./js/app.js?v=32",
