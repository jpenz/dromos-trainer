const CACHE = "dromos-trainer-v25";
const APP_SHELL = [
  "./", "./index.html", "./manifest.webmanifest", "./css/styles.css?v=25", "./css/fonts.css?v=14",
  ...
  "./js/triads.js?v=17", "./js/fretboard.js?v=19", "./js/guitar-voicings.js?v=14", "./js/audio.js?v=22", "./js/app.js?v=25",
