const CACHE = "dromos-trainer-v54";
const APP_SHELL = [
  "./", "./index.html", "./manifest.webmanifest", "./css/styles.css?v=54", "./css/fonts.css?v=14",
  ...
  "./js/triads.js?v=17", "./js/fretboard.js?v=52", "./js/guitar-voicings.js?v=14", "./js/audio.js?v=38", "./js/page-guides.js?v=54", "./js/app.js?v=54",
