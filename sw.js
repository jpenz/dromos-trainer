const CACHE = "dromos-trainer-v20";
const APP_SHELL = [
  "./", "./index.html", "./manifest.webmanifest", "./css/styles.css?v=19", "./css/fonts.css?v=14",
  ...
  "./js/tuning.js?v=14", "./js/profiles.js?v=15", "./js/theory.js?v=14", "./js/harmony-journey.js?v=15", "./js/modes.js?v=17", "./js/chord-map.js?v=17", "./js/ear-drills.js?v=14", "./js/styles.js?v=14", "./js/analysis.js?v=14", "./js/studies.js?v=14", "./js/musicxml.js?v=14", "./js/resources.js?v=14", "./js/video.js?v=14", "./js/coach.js?v=14", "./js/practice.js?v=14", "./js/toolkit.js?v=1",
  "./js/triads.js?v=17", "./js/fretboard.js?v=19", "./js/guitar-voicings.js?v=14", "./js/audio.js?v=16", "./js/app.js?v=19",
