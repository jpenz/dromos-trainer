...
| `js/chord-map.js` | FR-54 | MI-04, MI-07c, MI-10, MI-12 | `ChordMap.selfTest()` + exhaustive 60-map/5-tuning checks in `npm test` |
...
| `js/fretboard.js` | FR-02, FR-03, FR-10, FR-11, FR-16 | MI-10, MI-12 | geometry contract + `Modes.selfTest()` |
...
| `js/triads.js` | FR-25, FR-26, FR-49 | MI-12, MI-13, MI-14, MI-24 | `Triads.selfTest()` |
