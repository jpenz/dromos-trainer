...
| `js/picking-lab.js`, `js/audio.js` | FR-67, FR-68, FR-69 | MI-36, MI-37, MI-38 | `PickingLab.selfTest()` + category/source/stroke/accent/tremolo/ornament, route-aligned glide, loop/key/position, audio-unlock, and shell contracts in `npm test` |
