...
| `js/picking-lab.js` | FR-67 | MI-36 | `PickingLab.selfTest()` + category/source/stroke/accent/tremolo/ornament contracts in `npm test` |
...
| `js/app.js` | FR-04, FR-07, FR-12, FR-14, FR-15, FR-45…47, FR-49…51, FR-56…67 | MI-22, MI-26…36 | visual + answer-first page guides, Solo/Changes roadmaps, Matrix Chord Path, Melody Lab/sing-back, tactical-example and Picking Lab routing, toolkit focus, Comp transport/pulse browser regression + `npm test` |
