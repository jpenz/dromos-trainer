...
| `js/bouzouki-knowledge.js`, `js/picking-lab.js`, `js/audio.js` | FR-67, FR-68, FR-69, FR-70 | MI-36, MI-37, MI-38, MI-39 | `BouzoukiKnowledge.selfTest()` + `PickingLab.selfTest()` + category/source/articulation/stroke/accent/tremolo/ornament, mastery-order, route-aligned glide, loop/key/position, audio-unlock, and shell contracts in `npm test` |
...
| `js/app.js` | FR-04, FR-07, FR-12, FR-14, FR-15, FR-45…47, FR-49…51, FR-56…68 | MI-22, MI-26…37 | visual + answer-first page guides, Solo/Changes roadmaps, Matrix Chord Path, Melody Lab/sing-back, tactical examples, Picking Lab/run routing, toolkit focus, Comp transport/pulse regression + `npm test` |
